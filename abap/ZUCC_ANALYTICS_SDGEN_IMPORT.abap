...
CALL METHOD cl_gui_frontend_services=>file_open_dialog
  EXPORTING
    ...
    default_filename        = '2020GlobalBikeOrders.tsv'
*   file_filter             =
*   with_encoding           =
...
DATA lt_data_in TYPE TABLE OF zucc_analytics_sdgen_read.
...
*     isscanperformed         = SPACE
  ...
  DATA ls_data_out TYPE zucc_analy_sdgen.
  DATA lt_data_out TYPE TABLE OF zucc_analy_sdgen.
  CLEAR lt_data_out.
  ...
  MODIFY zucc_analy_sdgen FROM TABLE lt_data_out.
  IF sy-subrc <> 0.
    MESSAGE ID 'ZUCC_ANALYTICS' TYPE 'E' NUMBER 000 WITH sy-subrc.
  ENDIF.
